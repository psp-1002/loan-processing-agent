...
st.markdown("*Powered by LangGraph + LLaMA3 · Processes in 2 minutes vs 5 days*")
st.divider()
...
if submitted:
    ...
    col2.metric("DTI Ratio", f"{result['dti_ratio']}%")
    col3.metric("Property", result["property_valuation"])
    col4.metric("Risk Level", result["risk_score"])
